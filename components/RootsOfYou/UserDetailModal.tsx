        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                borderColor: `${barkGradient.from}40`,
                boxShadow: `0 20px 60px -12px ${barkGradient.from}30, 0 0 0 1px ${barkGradient.to}20`,
                maxHeight: '90vh'
              }}
            >
              {/* Animated background decoration with tree colors */}
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                  ...
                  style={{
                    background: `radial-gradient(circle, ${barkGradient.light}20, ${barkGradient.from}10)`
                  }}
                />
                <motion.div
                  animate={{
                  ...
                  style={{
                    background: `radial-gradient(circle, ${barkGradient.from}20, ${barkGradient.to}10)`
                  }}
                />
              </div>
              ...
              <div className="relative z-10">
                {/* Header Section with Profile Picture - Using tree/bark gradient */}
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${barkGradient.from} 0%, ${barkGradient.to} 100%)`
                  }}
                >
                    ...
                    {user.pfp_url && (
                      ...
                      >
                        ...
                        <img
                          ...
                          className="relative w-24 h-24 rounded-full border-[3px] border-white shadow-xl"
                        />
                        {/* Pro badge */}
                        {isPro && (
                          <motion.div
                ...
                <div className="p-4 space-y-3 max-h-[calc(90vh-280px)] overflow-y-auto overflow-x-hidden">
                  {/* Bio */}
                  {bio && (
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${barkGradient.light}10, ${barkGradient.from}5)`,
                        borderColor: `${barkGradient.from}30`
                      }}
                    >
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <motion.div
                      ...
                      className="rounded-lg p-3 border backdrop-blur-sm text-center"
                      style={{
                        background: `linear-gradient(135deg, ${barkGradient.light}10, ${barkGradient.from}5)`,
                        borderColor: `${barkGradient.from}30`
                      }}
                    >
                      <div className="text-lg font-bold" style={{ color: barkGradient.to }}>
                    ...
                    >
                      <div className="text-lg font-bold" style={{ color: barkGradient.to }}>
                        {castCount.toLocaleString()}
                      </div>
                      <div className="text-xs text-gray-600 mt-1">Fid</div>
                    </motion.div>
                  </div>

                  {/* Neynar Score and Wallet Address */}
                    ...
                    {neynarScore && (
                      ...
                      >
                        <div className="flex items-center space-x-1.5 mb-1.5">
                          <FontAwesomeIcon icon={faBullseye} className="w-3.5 h-3.5" style={{ color: barkGradient.to }} />
                          <h4 className="text-xs font-semibold text-gray-700">Neynar Score</h4>
                        </div>
                        <div className="text-xl font-bold" style={{ color: barkGradient.to }}>
                          {neynarScore}
                        </div>
                      </motion.div>
                    )}
                      ...
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          <div className="flex items-center space-x-1.5">
                            <FontAwesomeIcon icon={faLink} className="w-3.5 h-3.5" style={{ color: barkGradient.to }} />
                ...
                <motion.div
                  ...
                  style={{ borderColor: `${barkGradient.from}20` }}
                >
                  <motion.button
                    whileHover={{ scale: 1.02, boxShadow: `0 10px 30px -5px ${barkGradient.from}50` }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => {
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${barkGradient.from}, ${barkGradient.to})`
                    }}
                  >
